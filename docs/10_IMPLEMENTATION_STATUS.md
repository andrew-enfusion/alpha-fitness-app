...
- The next smallest valid task is the first Phase 3 slice on the Log destination: add the text-logging state and `ViewModel` foundation without revisiting shell, navigation, or placeholder-layout work.
