...
- The next smallest valid task should begin Phase 2 with the smallest deterministic onboarding/profile slice while preserving the existing architecture boundaries.
